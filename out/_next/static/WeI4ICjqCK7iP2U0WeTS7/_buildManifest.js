self.__BUILD_MANIFEST = {
  "/": [
    "static/chunks/0-gmib8h2ilm7.js"
  ],
  "/_error": [
    "static/chunks/17zwj7g1-klw9.js"
  ],
  "/change-name": [
    "static/chunks/0uvb-oer.icpn.js"
  ],
  "/change-password": [
    "static/chunks/0~vo2w1d_yu-~.js"
  ],
  "/login": [
    "static/chunks/0r9hpmso.7zor.js"
  ],
  "/oauth-callback": [
  ...
  "/settings": [
    "static/chunks/0orinb9rb50bu.js"
  ],
  "__rewrites": {
    "afterFiles": [],
    "beforeFiles": [],
  ...
  "sortedPages": [
    ...
    "/api/auth/guest",
    "/api/auth/guest/upgrade-intent",
    "/api/auth/login",
    "/api/auth/logout",
    "/api/auth/me",
    "/api/auth/oauth/callback/[provider]",
    "/api/auth/oauth/set-username",
