...
import { useSocialNotifications } from '../lib/useSocialNotifications';
...
export default function Rules() {
  ...
  const { overlay: socialOverlay } = useSocialNotifications({
    onNavigateHome: ({ expandParty }) => {
      router.push(expandParty ? '/?expandParty=1' : '/');
    },
  });
