                ...
                <>
                  <div className="settings-section" style={{ marginBottom: '12px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: resolvedTheme === 'light' ? '#FFFFFF' : 'rgba(0,0,0,0.35)', padding: '16px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.06)' }}>
                      ...
                      <button onClick={(e) => { e.preventDefault(); if (!saving) { setSaving(true); router.replace('/change-name'); } }} className="btn-gold" style={{ padding: '8px 16px', fontSize: '13px', margin: 0, width: 'auto' }}>
                        Edit
                      </button>
                    </div>
                  </div>
                  ...
                  {authProvider === 'local' && (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: resolvedTheme === 'light' ? '#FFFFFF' : 'rgba(0,0,0,0.35)', padding: '16px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.06)' }}>
                      ...
                      <button onClick={(e) => { e.preventDefault(); if (!saving) { setSaving(true); router.replace('/change-password'); } }} className="btn-gold" style={{ padding: '8px 16px', fontSize: '13px', margin: 0, width: 'auto' }}>
                        Update
                      </button>
                    </div>
                  )}
