...
function declare(gameState, playerId) {
  ...
  if ((gameState.turnsPlayedInRound || 0) < activePlayerCount) {
    return { error: 'Cannot declare until everyone has played at least one turn' };
  }
  ...
  if (activePlayers <= 1) {
    ...
    gameState.turnsPlayedInRound = 0;
  }
